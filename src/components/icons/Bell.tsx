...
export function Bell({ num }: { num: number }) {
  return (
      ...
      >
        <g fill="none">
          ...
          <path
            ...
            strokeLinecap="round"
            strokeWidth="1.95"
            d="M9.102 17.665c.171.957.548 1.802 1.072 2.405c.524.603 1.166.93 1.826.93c.66 0 1.302-.327 1.826-.93s.9-1.448 1.072-2.405"
          />
